...
// interactions are done via zookeeper, but a few (e.g., creating topics or
...
func (c *Client) GetBrokerPartitions(
	ctx context.Context,
	names []string,
) ([]PartitionInfo, error) {
	var topicNames []string
...
func (c *Client) UpdateTopicConfig(
	ctx context.Context,
	name string,
...
// The function returns the list of keys that were modified. If overwrite is
// set to false, this can be used to determine the subset of entries
func (c *Client) UpdateBrokerConfig(
	ctx context.Context,
	id int,
	configEntries []kafka.ConfigEntry,
	overwrite bool,
...
func (c *Client) GetControllerAddr(
	ctx context.Context,
) (string, error) {
	conn, err := kafka.DefaultDialer.DialContext(ctx, "tcp", c.bootstrapAddrs[0])
	if err != nil {
...
func (c *Client) AssignmentInProgress(
	ctx context.Context,
) (bool, error) {
	exists, _, err := c.zkClient.Exists(
		ctx,
...
func (c *Client) AssignPartitions(
	ctx context.Context,
	topic string,
...
func (c *Client) ElectionInProgress(
	ctx context.Context,
) (bool, error) {
	exists, _, err := c.zkClient.Exists(
		ctx,
...
func (c *Client) zNode(elements ...string) string {
